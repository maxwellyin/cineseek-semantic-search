...
3. `build_msrd_dataset.py` reads movie metadata and query relevance labels, caches sentence-transformer outputs for queries and items, then writes train/validation/test tensors for offline retrieval evaluation.
